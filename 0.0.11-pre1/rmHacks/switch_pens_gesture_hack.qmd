...
AFFECT [[2857280009207495592]]
    TRAVERSE [[254501108490678590]]
        LOCATE BEFORE ALL INSERT {
            function togglePens() {
                ~&5972376&~(~&233740416376353&~ == ~&3352516555792907411&~) {
                    ~&3352516555792907411&~ = ~&1414930695432821993&~;
                    ~&254547531013823564&~(~&"254547519794454865&~)
                } ~&6503784146&~ {
                    ~&3352516555792907411&~ = ~&233740416376353&~;
                    ~&254547531013823564&~(~&"233740920352621&~);
                }
            }
        }
    END TRAVERSE
